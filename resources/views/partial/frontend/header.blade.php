                                        ...
                                        <div class="item01 d-flex">
                                            <div class="thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('assets/posts/default_small.jpg') }}" width="50" height="50" alt="product images">
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h6><a href="product-details.html">yehya yehya yehya yehya yehya</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="switcher-options">
                                        <div class="switcher-currency-trigger">
                                            <div class="setting__menu">
                                                ...
                                                @guest
                                                    <span>
                                                        <a class="nav-link" href="{{ route('frontend.show_login_form') }}">Login</a>
                                                    </span>
                                                    
                                                    <span>
                                                        <a class="nav-link" href="{{ route('frontend.show_register_form') }}">Register</a>
                                                    </span>

                                                @else

                                                    <span><a href="#">My Dashboard</a></span>
                                                    <span><a href="{{ route('frontend.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Log out</a></span>
